  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden sm:flex flex-col gap-4">
        ...
        {/* WhatsApp Floating Button with Green Ripple */}
        <a
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 sm:hidden bg-[#1E1611]/95 backdrop-blur-md border-t border-[#C5A880]/40 p-2.5 shadow-2xl flex items-center gap-2">
        <a
          href={`tel:${hotelInfo.phoneRaw}`}
          className="flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg border border-[#C5A880]/50 text-white font-bold text-xs uppercase tracking-wider bg-[#2A201A] active:scale-98 transition-all"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg bg-[#25D366] text-white font-bold text-xs uppercase tracking-wider active:scale-98 transition-all shadow-md"
        >
